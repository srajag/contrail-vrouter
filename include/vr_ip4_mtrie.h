...
#define MTRIE_SHIFT16_HASH(ip)      (((ip) >> 16) ^ (ip))
#define MTRIE_CRC_HASH(ip)          (_mm_crc32_u32(1, (ip)))

#ifdef __SSE4_2__
#define MTRIE_HASH(ip)              MTRIE_CRC_HASH(ip)
#else
#define MTRIE_HASH(ip)              MTRIE_SHIFT16_HASH(ip)
#endif
struct ip4_mtrie {
