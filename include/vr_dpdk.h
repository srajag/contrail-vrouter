...
/* Number of mbufs in FRAGMENTATION mempool */
#define VR_DPDK_FRAGMENTATION_MEMPOOL_SZ     1024 
/* How many objects (mbufs) to keep in per-lcore FRAGMENTATION mempool cache */
#define VR_DPDK_FRAGMENTATION_MEMPOOL_CACHE_SZ    (VR_DPDK_MAX_BURST_SZ*8)
...
struct vr_dpdk_global {
    ...
    /* Pointer to IP fragmentation memory pool */
    struct rte_mempool *fragmentation_mempool;
